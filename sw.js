...
const CACHE = 'karriaro-mobile-v418';
const OFFLINE_URL = '/offline.html';
const SHELL = [
    '/',
    '/offline.html',
    '/css/mobile.css',
    '/css/mobile-overrides.css?v=418',
    '/css/tokens.css',
    '/css/modern-2026.css?v=418',
    '/js/m-interactions.js?v=418',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
...
// Cache-Bust v=418 invalidiert). Sheet-Modal-Open lädt sie idealerweise
