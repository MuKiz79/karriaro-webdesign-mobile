...
const CACHE = 'karriaro-mobile-v421';
const OFFLINE_URL = '/offline.html';
const SHELL = [
    '/',
    '/offline.html',
    '/css/mobile.css',
    '/css/mobile-overrides.css?v=421',
    '/css/tokens.css',
    '/css/modern-2026.css?v=421',
    '/js/m-interactions.js?v=421',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
...
// Cache-Bust v=421 invalidiert). Sheet-Modal-Open lädt sie idealerweise
