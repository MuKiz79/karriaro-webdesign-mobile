...
const CACHE = 'karriaro-mobile-v419';
const OFFLINE_URL = '/offline.html';
const SHELL = [
    '/',
    '/offline.html',
    '/css/mobile.css',
    '/css/mobile-overrides.css?v=419',
    '/css/tokens.css',
    '/css/modern-2026.css?v=419',
    '/js/m-interactions.js?v=419',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
...
// Cache-Bust v=419 invalidiert). Sheet-Modal-Open lädt sie idealerweise
