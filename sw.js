...
const CACHE = 'karriaro-mobile-v420';
const OFFLINE_URL = '/offline.html';
const SHELL = [
    '/',
    '/offline.html',
    '/css/mobile.css',
    '/css/mobile-overrides.css?v=420',
    '/css/tokens.css',
    '/css/modern-2026.css?v=420',
    '/js/m-interactions.js?v=420',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
...
// Cache-Bust v=420 invalidiert). Sheet-Modal-Open lädt sie idealerweise
