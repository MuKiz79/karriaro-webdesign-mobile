...
const CACHE = 'karriaro-mobile-v413';
const OFFLINE_URL = '/offline.html';
const SHELL = [
    '/',
    '/offline.html',
    '/css/mobile.css',
    '/css/mobile-overrides.css?v=413',
    '/css/tokens.css',
    '/css/modern-2026.css?v=413',
    '/js/m-interactions.js?v=413',
    '/icons/icon-192.png',
    '/icons/icon-512.png',
...
// Cache-Bust v=413 invalidiert). Sheet-Modal-Open lädt sie idealerweise
